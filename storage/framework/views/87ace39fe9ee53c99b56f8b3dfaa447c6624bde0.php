...
<?php $__env->startSection('title', 'МТЗ Беларус 1221 — RED LEASING'); ?>

<?php $__env->startSection('content'); ?>
  <div class="container">
    <div class="breadcrumb"><a href="<?php echo e(url('/catalog')); ?>">Каталог</a> / МТЗ Беларус 1221</div>

    <div class="top">
      <div class="left">
        <h1>МТЗ Беларус 1221 трактор в лизинг</h1>
        <p class="subtitle">Дизельный 7 л, 130 л.с., механика, полный привод, спецтехника · Новый</p>
        <img src="<?php echo e(asset('cars/special.png')); ?>" alt="МТЗ Беларус 1221" class="main-img">
...
<?php $__env->startPush('scripts'); ?>
  <script src="<?php echo e(asset('js/car-calc.js')); ?>"></script>
<?php $__env->stopPush(); ?>

<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\OSPanel\home\practice-register\resources\views/car5.blade.php ENDPATH**/ ?>