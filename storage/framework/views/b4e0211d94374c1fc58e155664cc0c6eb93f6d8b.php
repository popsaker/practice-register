...
<?php $__env->startSection('title', 'Chery Arrizo 8 — RED LEASING'); ?>

<?php $__env->startSection('content'); ?>
  <div class="container">
    <div class="breadcrumb"><a href="<?php echo e(url('/catalog')); ?>">Каталог</a> / Chery Arrizo 8</div>
    ...
    <div class="top">
      <div class="left">
        ...
        <img src="<?php echo e(asset('cars/sedan.png')); ?>" alt="Chery Arrizo 8" class="main-img">
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\OSPanel\home\practice-register\resources\views/car1.blade.php ENDPATH**/ ?>